                    ...
                    <div className="breadcrumb-container" style={{ height: '140px' }}>
                        <div className="py-5 text-center d-flex align-items-center justify-content-center">
                            <ul className='list-unstyled d-flex align-items-center justify-content-center'>
                                <li><Home /></li>
                                <li className="ms-2 text-black">| Brand</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-9 col-md-6 col-sm-12">
                            <div className="container p-4">
                                <div className="mb-4">
                                    <span className="fw-bold">Brand Index:</span>
                                    <span className="ms-2">A</span>
                                    <span className="ms-2">C</span>
                                    <span className="ms-2">H</span>
                                    <span className="ms-2">P</span>
                                    <span className="ms-2">S</span>
                                </div>
                                {[
                                    { letter: 'A', brand: 'Apple' },
                                    { letter: 'C', brand: 'Canon' },
                                    { letter: 'H', brand: 'Hewlett-Packard' },
                                    { letter: 'P', brand: 'Palm' },
                                    { letter: 'S', brand: 'Sony' }
                                ].map(item => (
                                    <div className="mb-4" key={item.letter}>
                                        <div className="bg-light p-2 fw-bold">{item.letter}</div>
                                        <div className="p-2">
                                            {item.brands ? (
