                ...
                <div className="breadcrumb-container" style={{ height: '140px' }}>
                    <div className="py-5 text-center d-flex align-items-center justify-content-center">
                        <ul className='list-unstyled d-flex align-items-center justify-content-center'>
                            <li><Home /></li>
                            <li className="ms-2 text-black">| Fashion</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-lg-9 col-md-6-col-sm-12">
                        <div className="">
                            <p className="mb-0 fw-bold">FASHION</p>
                            <p className="text-muted mb-4">
                                Faded short sleeves t-shirt with high neckline. Soft and stretchy material for a comfortable fit. Accessorize with a straw hat and you're ready for summer! Accessorize with a straw hat and you're ready for summer! Accessorize with a straw hat and you're ready for summer! Faded short sleeves t-shirt with high neckline. Soft and stretchy material for a comfortable fit. Accessorize with a straw hat and you're ready for summer!...
                            </p>
                            <div className="row g-4">
                                <div className="col-12 col-md-4 text-center">
                                    <a href="">
                                        <img src={fashion_img1} alt="Black wristwatch with a black strap" className="img-fluid mb-2 border" />
                                    </a>
                                    <p className="text-muted">Shoes (3)</p>
                                </div>
                                <div className="col-12 col-md-4 text-center">
                                    <a href="">
                                        <img src={fashion_img2} alt="Plain white t-shirt" className="img-fluid mb-2 border" />
                                    </a>
                                    <p className="text-muted">Tops (5)</p>
                                </div>
                                <div className="col-12 col-md-4 text-center">
                                    <a href="">
                                        <img src={fashion_img3} alt="Light blue sleeveless blouse" className="img-fluid mb-2 border" />
                                    </a>
                                    <p className="text-muted">Dresses (3)</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-12">
                        <div className="border border-secondary w-100" style={{ maxWidth: '300px' }}>
                            ...
                            <div className="px-4 pb-3">
                                ...
                                <Link to="#" className='text-decoration-none btn btncolor text-white'>
