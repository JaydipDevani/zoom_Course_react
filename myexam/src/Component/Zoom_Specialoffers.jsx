...
const Zoom_Specialoffers = () => {
    ...
    const products1 = [
        ...
        { id: 3, name: "HTC Touch HD", price: "$122.00", image: fashion_img7, rating: 0 },
        { id: 4, name: "Top Like T-Shirt", price: "$122.00", image: fashion_img6, rating: 0 },
    ];
                    ...
                    <div className="breadcrumb-container" style={{ height: '140px' }}>
                        <div className="py-5 text-center d-flex align-items-center justify-content-center">
                            <ul className='list-unstyled d-flex align-items-center justify-content-center'>
                                <li><Home /></li>
                                <li className="ms-2 text-black">| Special Offers</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-lg-9 col-md-6 col-sm-12">
                            ...
                            <div className="p-3" style={{ backgroundColor: "#eee" }}>
                                <p className="text-secondary m-0">Showing 1 to 4 of 4 (1 Pages)</p>
                            </div>
                        </div>
                    </div>
                </div>
...
export default Zoom_Specialoffers    
